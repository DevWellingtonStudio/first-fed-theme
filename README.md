...
The default branch is under development, use [v4](https://github.com/webdevsuperfast/frst-fed-theme/tree/v4) branch to get the last stable release.
...
Use [SmartMenus for Bootstrap](https://github.com/webdevsuperfast/ra-smartmenus-bootstrap) for multi-level dropdown support or checkout the [v4](https://github.com/webdevsuperfast/frst-fed-theme/tree/v4) branch.
